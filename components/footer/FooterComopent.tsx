        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-[100px]">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            >
              ...
              <h2 className="text-xl md:text-2xl font-bold mb-3 text-center md:text-left">Social Media Platform</h2>
              <div className="flex gap-4">
                {[
                  ...
                  >
                    <social.icon size={18} className="text-iDonate-navy-primary"/>
                  </Link>
                ))}
              </div>
            </motion.div>
            ...
            >
              <p className="text-base md:text-lg mb-1">Donation Change their life</p>
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-[100px] py-8 bg-white">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-0 justify-center md:justify-start">
              <Image
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-xl font-semibold mb-4 text-iDonate-navy-primary text-center md:text-left">Stay Up To Date</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-4 text-iDonate-navy-primary text-center md:text-left">Our Sponsor</h3>
