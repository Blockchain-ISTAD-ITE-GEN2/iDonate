        ...
        <section className="mx-[100px] h-[600px]">
            <div className="grid px-4 py-8 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                ...
                <div className="lg:col-span-7 mt-0 mr-[100px]">
                    ...
                    >
                        ការអប់រំគឺជាវិធីដ៏ល្អបំផុតដើម្បីផ្លាស់ប្តូរចិត្តស្មារតី និង បង្កើតអនាគតដ៏ល្អសម្រាប់កុមារកម្ពុជា។
                        បរិច្ចាគត្រឹមតែបន្តិចអាចជួយកុមារដែលខ្វះខាតទទួលបានឱកាសក្នុង​ការសិក្សា បង្កើតសុភមង្គលជីវិត
                        និងសម្រេចក្តីសុបិន្ត។ ចូលរួមជាមួយយើងដើម្បីធ្វើអោយក្តីសុបិន្តរបស់ពួកគេក្លាយទៅជាការពិត។
                    </p>
