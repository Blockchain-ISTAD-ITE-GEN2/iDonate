...
export default function CategoryOnPageComponent() {
  ...
  const categories = [
    ...
    },
    {
      ...
      media:
        "https://charius-next.netlify.app/_next/static/media/2.15763a18.svg",
    },
    {
      title: "ការថែទាំ សុខភាព",
      media:
        "https://charius-next.netlify.app/_next/static/media/4.41949be1.svg",
    },
  ];
  ...
  const eventData: EventTypeParam[] = [
    {
      image:
        "https://media.istockphoto.com/id/547404780/photo/local-students-in-cambodia.jpg?s=612x612&w=0&k=20&c=e5bAh7pAa87T2eKj1XJ9PgaMztkImfSVS4UAwb8zF-o=",
    ...
    {
      image:
        "https://www.unicef.org/cambodia/sites/unicef.org.cambodia/files/styles/hero_extended/public/EGR%20Grade%202_Ratanakiri_December2023_Cristyn%20Lloyd_26.jpg.webp?itok=X3j0lSpb",
    ...
    {
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-nhNl60H50EO2WVCeu_0m_FRHDAFBxoYoGg&s",
      title: "ការជួបប្រជុំសំខាន់ជាមួយអង្គការសប្បុរសធម៌",
      description:
        "អង្គការសប្បុរសធម៌ជួបប្រជុំដើម្បីបង្កើតការផ្លាស់ប្តូរជាពិសេស",
      total_donor: 200,
      total_amount: 10000,
    },
    {
  ...
  return (
    <>
      ...
      <section
        lang={"km"}
        className=" flex items-center justify-center gap-[100px] mb-[24px]"
      >
