    ...
    className="w-full rounded-[10px] bg-iDonate-light-gray border-0 cursor-pointer shadow-md transition-transform hover:scale-[1.02]">
      <CardContent className="flex flex-col sm:flex-row items-center justify-center p-4 gap-4">
        ...
        <div className="flex flex-col h-full gap-2 flex-1">
          <h2 className="text-description-eng sm:text-medium-eng font-semibold text-iDonate-navy-primary">
            {title}
          </h2>

          <p className="flex-1 text-sub-description-eng text-iDonate-navy-secondary  sm:line-clamp-4">
            {description}
          </p>

          {/* Location */}
          <div className="flex gap-2 text-iDonate-gray">
