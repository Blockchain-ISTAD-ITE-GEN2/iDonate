...
import { Heart, Search, Menu, X, ChevronRight, ChevronLeft, User, LogOut } from "lucide-react";
...
const ProfileDropdown = ({ session, signOut }: { session: any, signOut: any }) => {
  return (
      <DropdownMenu>
          <DropdownMenuTrigger>
              {session?.user?.image ? (
          ...
          <DropdownMenuContent className="w-64 p-2">
              ...
              <div className="p-3">
                  <div className="flex items-center space-x-3">
                      ...
                      <div className="text-sm">
                          <div className="font-medium text-gray-900">{session?.user?.name || "Guest User"}</div>
              ...
              <DropdownMenuItem asChild>
                  <Link href="/donations" className="flex items-center space-x-2 cursor-pointer">
    ...
    const MobileSubmenu = () => (
      <div className="fixed inset-0 bg-white z-50 lg:hidden">
          ...
          <div className="p-4 bg-white">
              <h2 className="text-xl font-semibold mb-4 text-iDonate-navy-primary ml-1">{activeSubmenu}</h2>
      ...
      <div className="fixed inset-0 bg-white z-50 lg:hidden">
          <div className="p-4 flex justify-between items-center border-b bg-white ">
              <div className="flex items-center space-x-2 bg-white ">
                  ...
                  <span className="text-lg dark:text-white text-iDonate-navy-primary">iDonate</span>
              </div>
