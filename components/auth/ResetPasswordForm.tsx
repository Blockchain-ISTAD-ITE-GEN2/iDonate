  ...
  return (
    <Card className="w-full">
      <CardHeader className="space-y-1">
        <CardTitle className="text-2xl font-semibold text-center text-iDonate-navy-primary">កំណត់ពាក្យសម្ងាត់របស់អ្នក
        </CardTitle>
          ...
          {success && (
            <Alert>
              <AlertDescription className='text-iDonate-navy-primary'>
                ពាក្យសម្ងាត់របស់អ្នកត្រូវបានកំណត់ថ្មីដោយជោគជ័យ។​ អ្នកអាចចូលប្រើគណនីរបស់អ្នកជាមួយនឹងពាក្យសម្ងាត់ថ្មីរបស់អ្នកបានហើយ
              </AlertDescription>
            </Alert>
          )}
          <Button type="submit" className="w-full bg-iDonate-green-primary hover:bg-iDonate-green-secondary text-iDonate-navy-primary" disabled={isLoading}>
