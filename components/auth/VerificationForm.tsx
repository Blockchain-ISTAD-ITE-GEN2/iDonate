    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <Card className="w-full max-w-md bg-whitesmoke">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl text-center text-iDonate-navy-primary">
            ការផ្ទៀងផ្ទាត់ 2 ជំហាន
          </CardTitle>
          <CardDescription className="text-center text-iDonate-navy-secondary">
            យើងបានផ្ញើលេខកូដផ្ទៀងផ្ទាត់ទៅអ៉ីមែលរបស់អ្នក។
            សូមបញ្ចូលលេខកូដដើម្បីបន្ត។
          </CardDescription>
        </CardHeader>
        ...
        <CardFooter className="flex flex-col gap-2">
          ...
          >
            {timer > 0
              ? `ផ្ញើលេខកូដម្តងទៀតក្នុងរយៈពេល ${timer}វិ`
              : "ផ្ញើលេខកូដម្តងទៀត"}
          </Button>
        </CardFooter>
      </Card>
