...
export const userProfileSettingApi = idonateApi.injectEndpoints({
    ...
    endpoints: (builder) => ({
		...
		// update avatar user
		updateAvatar: builder.mutation<any, { uuid: any, updatedProfileImage: UpdateProfileImageType; }>({
		...
		updatePassWords: builder.mutation<any, { uuid: string, updatedPassword: ChangePasswordType; }>({
