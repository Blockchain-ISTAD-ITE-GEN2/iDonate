...
export default function Page() {
  ...
  const eventData: EventType[] = [
    ...
    {
      image:
        "https://c8.alamy.com/comp/ADB76P/children-learning-english-at-a-school-in-kampot-cambodia-ADB76P.jpg",
      title: "ការជួបប្រជុំសំខាន់ជាមួយអង្គការសប្បុរសធម៌",
      description:
        "អង្គការសប្បុរសធម៌ជួបប្រជុំដើម្បីបង្កើតការផ្លាស់ប្តូរជាពិសេស",
      total_donor: 200,
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap justify-end my-[24px] mr-[100px]">
