...
export const metadata: Metadata = {
    ...
    description: 'Browse through various organizations on iDonate, discover their missions, and get involved.',
    keywords: ['iDonate', 'Organizations', 'Nonprofit Organizations', 'Charity Organizations', 'Support'],
    openGraph: {
        title: 'Organizations - iDonate',
        description: 'Find nonprofit organizations on iDonate and learn about their missions and how you can contribute.',
    ...
    twitter: {
        ...
        title: 'Organizations - iDonate',
        description: 'Explore nonprofit organizations on iDonate and get involved with the causes you care about.',
