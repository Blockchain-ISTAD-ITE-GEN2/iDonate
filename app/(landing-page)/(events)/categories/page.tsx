...
export const metadata: Metadata = {
    ...
    description: 'Browse all categories on iDonate to discover causes and organizations that align with your values.',
    keywords: ['iDonate', 'Categories', 'Donation Categories', 'Charity Causes', 'Nonprofit Organizations'],
    openGraph: {
        title: 'Categories - iDonate',
        description: 'Explore categories on iDonate and find organizations and causes that matter to you.',
    ...
    twitter: {
        ...
        title: 'Categories - iDonate',
        description: 'Find the causes and organizations that matter to you in the iDonate categories.',
