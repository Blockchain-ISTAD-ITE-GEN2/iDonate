...
export const metadata: Metadata = {
    ...
    description: 'Search for donation requests, organizations, and events on iDonate.',
    keywords: ['iDonate', 'Search', 'Donation Requests', 'Organizations', 'Events'],
    openGraph: {
        title: 'Search - iDonate',
        description: 'Find donation requests, organizations, and events on iDonate.',
