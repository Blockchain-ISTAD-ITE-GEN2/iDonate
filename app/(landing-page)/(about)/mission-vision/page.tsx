...
export const metadata: Metadata = {
  ...
  description: 'Discover the mission and vision that drive iDonate to create a trustworthy and impactful donation platform.',
  keywords: ['iDonate', 'Mission', 'Vision', 'Donation Platform', 'Transparency', 'Impact'],
  openGraph: {
    title: 'Our Mission & Vision - iDonate',
    description: 'Learn about iDonate’s mission to ensure transparency and our vision for creating a world of impactful donations.',
  ...
  twitter: {
    ...
    title: 'Our Mission & Vision - iDonate',
    description: 'Explore iDonate’s mission and vision, ensuring trust and impactful giving.',
