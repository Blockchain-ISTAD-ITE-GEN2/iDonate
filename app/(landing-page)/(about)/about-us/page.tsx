...
export const metadata: Metadata = {
    ...
    description: 'Learn more about the team and mentors behind iDonate, ensuring transparency and credibility in donation requests.',
    keywords: ['iDonate', 'About Us', 'Team', 'Mentors', 'Donation Platform'],
    openGraph: {
        title: 'About Us - iDonate',
        description: 'Meet the passionate team and mentors who ensure transparency and credibility on iDonate.',
    ...
    twitter: {
        ...
        title: 'About Us - iDonate',
        description: 'Discover the team and mentors behind iDonate, ensuring trust and credibility in donations.',
